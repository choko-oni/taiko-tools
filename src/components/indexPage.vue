        ...
        <div class="toolbar">
            <el-row :gutter="24" class="row-bar">
                <el-col :span="12" class="left-col">
                    ...
                    <el-select v-model="sectionNumber" placeholder="请选择小节内音符数量" class="section-number">
                        <el-option
...
<!--                            1小节-->
                            <div class="surface-part">
                                <div class="part-item" v-for="(item,index) in sectionNumber" :style="{'width':partLength+'px',}"></div>
                            </div>
                        </div>
                        <div class="determine">
                            <div class="circle">
