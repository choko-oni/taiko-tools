        ...
        <div class="toolbar">
            <el-row :gutter="24" class="row-bar">
                <el-col :span="12" class="left-col">
                    ...
                    <el-select v-model="sectionNumber" @change="onChangeSection" placeholder="请选择小节内音符数量"
                ...
                <el-col :span="12" class="right-col">
                    ...
                    <draggable group="field" class="surface-part"
                               ...
                               @end="end1"
                               v-bind="dragOptions"
                               :options="{group:{name: 'field',pull:'clone'},sort: true}" animation="300" :move="onMove"
                               @change="log">
                        <!--            <transition-group>-->
    ...
    export default {
        ...
        methods: {
            ...
            end1(e) {
                ...
                var that = this;
                var items = this.sectionList.filter(function (m) {
                    return m.id == that.moveId
                })
                //如果左边
                if (items.length < 2) return;

                this.sectionList.push(e.newDraggableIndex)
                // this.sectionList.splice(e.newDraggableIndex, 1)
            },
            //move回调方法
...
<!-- Add "scoped"  lang="scss" attribute to limit CSS to this component only -->
<style scoped>
    .index-wrapper {
        margin: 0;
    }
